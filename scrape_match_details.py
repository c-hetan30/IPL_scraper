# scrapy runspider -o match_details.csv scrape_match_details.py 
...
class cric_match(scrapy.Spider):
    ...
    #starting url
    #start_urls = ['https://www.espncricinfo.com/scores/series/8048/season/2015/indian-premier-league?view=results']
    #start_urls = ['https://www.espncricinfo.com/scores/series/8048/season/2014/pepsi-indian-premier-league?view=results']
    ...
    def parse_match(self, response):
        ...
        if("won" in str(win)):
            ...
            win_map = {"Mumbai Indians":"Indians",
            "Delhi Capitals" :"Capitals",
            "Delhi Daredevils" : "Daredevils",
            "Deccan Chargers" : "Chargers",
            "Kochi Tuskers Kerala" : "Kochi",
            "Pune Warriors India" : "Warriors",
            "Pune Warriors" : "Warrior",
            "Rising Pune Supergiants" :"Supergiants",
            "Rising Pune Supergiant" :"Supergiant", 
            "Gujarat Lions" : "Lions",
            "Chennai Super Kings":"Super Kings",
            "Sunrisers Hyderabad":"Sunrisers",
            "Rajasthan Royals":"Royals",
